<template>
    <div>
        <div class="main">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="470" height="290"
                ...
                <g fill="none" fill-rule="evenodd">
                    <path d="M0 0H1366V800H0z" transform="translate(-448 -157)" />
        ...
        <div class="flex flex-col align-middle items-center m-6 ">
            <h2 class="uppercase text-3xl p-2 mb-6">You seem to be lost</h2>
            <router-link to="/">
